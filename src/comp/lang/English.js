...
export default class English extends Component {
  ...
  render() {
    return (
      <div>
        <Popular
          url="https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&page=1&sort_by=primary_release_date.desc&vote_count.gte=10&with_original_language=en&api_key=972bf2f0b5a2dba4a5df2e4153bd68ec"
